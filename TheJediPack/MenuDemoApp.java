...
class MenuFrame extends Frame implements ItemListener, ActionListener {
    ...
    public MenuFrame(String title) {
        ...
        CoolWindowAdapter adapter = new CoolWindowAdapter(this);
...
class MyMenuHandler implements ActionListener, ItemListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        menuFrame.msg = "You selected " + ae.getActionCommand();
        menuFrame.repaint();
    }
...
class CoolWindowAdapter extends WindowAdapter {
    MenuFrame menuFrame;

    public CoolWindowAdapter(MenuFrame menuFrame) {
        this.menuFrame = menuFrame;
    }
