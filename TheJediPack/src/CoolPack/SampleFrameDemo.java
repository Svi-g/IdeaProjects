...
// create an object to handle window events
        MyWindowAdapterDemo2 adapter = new MyWindowAdapterDemo2
                (this);
...
class MyWindowAdapterDemo2 extends WindowAdapter {
    SampleFrameDemo sampleFrame;
    public MyWindowAdapterDemo2(SampleFrameDemo sampleFrame) {
...
// Applet window.
 class WindowEvents extends Applet
        implements MouseListener, MouseMotionListener {
    SampleFrame f;
    String msg = "";
